#!/usr/bin/env python
# Run this script to create bash functions
# to quickly set path for the different
# versions of python installed on your mac
...
if __name__ == '__main__':
    ...
    outname = os.path.expandvars("$HOME/dotfiles/python_switchers.sh")
